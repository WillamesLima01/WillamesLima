...
const EquineForm = () => {
    const [equine, setEquine] = useState({ name: '', birthDate: '', coat: '', inclusion: '', record: '', local: '', sex: '', imagem1: '', imagem2: '', imagem3: '', imagem4: '' });
    ...
    useEffect(() => {
        if(id) {
            ...
            setEquine({ name: '', birthDate: '', coat: '', inclusion: '', record: '', local: '', sex: '', imagem1: '', imagem2: '', imagem3: '', imagem4: '' });
        }       
    }, [id]);
            ...
            <form className={`${styles.container} mt-5`} onSubmit={handleSubmit}>
                ...
                <section className={styles.etapa2}>
                    ...
                    <div className="form-floating">
                        <input type="date" className="form-control" id="floatingInputValue" placeholder="Date" value={equine.birthDate} onChange={handleChange} />
                        <label htmlFor="floatingInputValue">Data de Nascimento</label>
                    </div>

                    <div className={styles.resenhadescritiva}>
                        <label className={styles.styloNomeResenha} htmlFor="resenha">Resenha descritiva</label>
                        <textarea id="resenha" name="resenha" className="form-control" rows="7" cols="10" value={equine.resenha} onChange={handleChange}></textarea>
                    </div>
                </section>
