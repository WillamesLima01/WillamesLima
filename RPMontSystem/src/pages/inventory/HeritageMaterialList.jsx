...
const HeritageMaterialList = () => {
  ...
  return (
    <div className={styles.container} mt-5>     
        ...
        <button onClick= {() => navigate('/inventory/add-produto')} className="btn btn-primary mb-2">Adicionar Material</button>
                    ...
                    products.map(product => (
                        <tr key={product.id}>
                            ...
                            <td className={styles.btAcao}>
                                <button title='editar' className="btn btn-sm btn-warning me-md-2" onClick={() => navigate(`/inventory/editar-produto/${product.id}`)}>
